...
import ContractClientList from "../views/MS-ContractClientListPage.vue";
import ContractClientDetail from "../views/MS-ContractClientDetailPage.vue";
import ContractClientEdit from "../views/MS-ContractClientEditPage.vue";
import ContractClientEditConfirm from "../views/MS-ContractClientEditConfirmPage.vue";
import ContractClientEditComplete from "../views/MS-ContractClientEditCompletePage.vue";
import ContractClientRequestOutput from "../views/MS-ContractClientRequestOutputPage.vue";
import ClientUserList from "../views/MS-ClientUserListPage.vue";
import ClientUserDetail from "../views/MS-ClientUserDetailPage.vue";
import ProUserList from "../views/MS-ProUserListPage.vue";
import ProUserCreate from "../views/MS-ProUserCreatePage.vue";
import ProUserCreateConfirm from "../views/MS-ProUserCreateConfirmPage.vue";
import ProUserCreateComplete from "../views/MS-ProUserCreateCompletePage.vue";
import ProUserDetail from "../views/MS-ProUserDetailPage.vue";
import ProUserDetailEdit from "../views/MS-ProUserDetailEditPage.vue";
import ProUserDetailEditConfirm from "../views/MS-ProUserDetailEditConfirmPage.vue";
import ProUserDetailEditComplete from "../views/MS-ProUserDetailEditCompletePage.vue";
import MsUserList from "../views/MS-MsUserListPage.vue";
import MsUserRegist from "../views/MS-MsUserRegistPage.vue";
import MsUserRegistConfirm from "../views/MS-MsUserRegistConfirmPage.vue";
import MsUserRegistComplete from "../views/MS-MsUserRegistCompletePage.vue";
import MsUserDetail from "../views/MS-MsUserDetailPage.vue";
import MsUserEdit from "../views/MS-MsUserEditPage.vue";
import MsUserEditConfirm from "../views/MS-MsUserEditConfirmPage.vue";
import MsUserEditComplete from "../views/MS-MsUserEditCompletePage.vue";
